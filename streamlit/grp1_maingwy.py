...
with tab3:
    ...
    st.write("In this webpage, Tasty Byte management will have the ability to obtain details about churn customers across various customer segments. They can leverage the insights and advice provided by the system to take proactive measures aimed at retaining these customers.")
    ...
    st.caption("Out of all the " + str(cust_seg_option) + " customers, "+ str(len(cust_to_show)) + " of them are likely to churn as the average time since their last order is approximately " + str(avg_churn_recency) + " days, compared to unlikely to churn customers of " + str(avg_not_churn_recency) + " days.")
    st.caption("These customers have a predicted "+ min_predicted + "-"+ max_predicted + " days to next purchase range, with the average customers having a predicted " + avg_predicted + " days to next purchase.")
    ...
    if cust_seg_option == "High Value":
        ...
        st.caption("Another suggestion is to focus on the middle value customers that are more likely to purchase in the next "+ min_predicted + "-" + avg_predicted + " days, rather than customers predicted to purchase in eg. " + max_predicted + " days. This can impact overall retention rates more effectively and generate quicker positive results compared to those with longer predicted purchase timelines.") 
    else:
        ...
        st.caption("Another suggestion is to focus on the low value customers that are more likely to purchase in the next "+ min_predicted + "-" + avg_predicted + " days, rather than customers predicted to purchase in eg. " + max_predicted + " days. This can impact overall retention rates more effectively and generate quicker positive results compared to those with longer predicted purchase timelines.") 
